...
jQuery(function() { 
    ...
    if(url_atual.indexOf("/hotels/") != -1){
        jQuery("#field_date_checkin_ehtl").val(localStorage.getItem("CHECKIN_EHTL"));
        jQuery("#field_date_checkout_ehtl").val(localStorage.getItem("CHECKOUT_EHTL"));
        jQuery("#adultos").val(localStorage.getItem("ADT_EHTL"));
        jQuery("#criancas").val(localStorage.getItem("CHD_EHTL"));
        jQuery("#quartos").val(localStorage.getItem("QTD_QUARTOS"));
    }
